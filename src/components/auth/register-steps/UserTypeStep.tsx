				...
				<div className="grid grid-cols-1 gap-4">
					...
					>
						<div className="flex items-center">
							<div
								className={`p-2 rounded-full ${formData.userType === "seeker" ? "bg-rose-100" : "bg-gray-100"}`}
							>
								<User
									className={`h-6 w-6 ${formData.userType === "seeker" ? "text-rose-600" : "text-gray-500"}`}
								/>
							</div>
							<div className="ml-4">
								...
								<p className="text-sm text-gray-500">
									I'm looking to rent or buy property
								</p>
							</div>
						</div>
					</div>
					...
					>
						<div className="flex items-center">
							<div
								className={`p-2 rounded-full ${formData.userType === "provider" ? "bg-rose-100" : "bg-gray-100"}`}
							>
								<Building
									className={`h-6 w-6 ${formData.userType === "provider" ? "text-rose-600" : "text-gray-500"}`}
								/>
							</div>
							<div className="ml-4">
								<h4 className="text-base font-medium">
					...
					<div className="mt-6">
						...
						<div className="grid grid-cols-2 gap-4">
							<div
								...
								onClick={() =>
									updateFormData({ providerType: "agent" })
								}
							>
								<div className="text-center">
									...
									<p className="text-xs text-gray-500">
										I represent multiple properties
									</p>
								</div>
							</div>
