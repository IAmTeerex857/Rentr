...
interface CredentialsStepProps {
  ...
  updateFormData: (data: Partial<{ email: string; password: string; confirmPassword: string }>) => void;
  nextStep: () => void;
  prevStep: () => void;
}
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-500 mb-4">Enter your email and create a secure password</p>
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`pl-10 block w-full shadow-sm rounded-md py-3 px-4 border ${
                  errors.email ? 'border-red-300 focus:ring-red-500 focus:border-red-500' : 'border-gray-300 focus:ring-rose-500 focus:border-rose-500'
                }`}
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                onChange={handleChange}
                className={`pl-10 block w-full shadow-sm rounded-md py-3 px-4 border ${
                  errors.password ? 'border-red-300 focus:ring-red-500 focus:border-red-500' : 'border-gray-300 focus:ring-rose-500 focus:border-rose-500'
                }`}
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                onChange={handleChange}
                className={`pl-10 block w-full shadow-sm rounded-md py-3 px-4 border ${
                  errors.confirmPassword ? 'border-red-300 focus:ring-red-500 focus:border-red-500' : 'border-gray-300 focus:ring-rose-500 focus:border-rose-500'
                }`}
