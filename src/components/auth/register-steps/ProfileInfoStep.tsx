...
import { ArrowLeft, ArrowRight, UserCircle, Phone, MapPin, Upload } from 'lucide-react';
      ...
      <div>
        ...
        <div className="flex justify-center mb-6">
          <div className="relative">
            ...
            <label htmlFor="avatar-upload" className="absolute bottom-0 right-0 bg-rose-600 rounded-full p-2 cursor-pointer shadow-sm">
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                className={`block w-full shadow-sm rounded-md py-3 px-4 border ${
                  errors.firstName ? 'border-red-300 focus:ring-red-500 focus:border-red-500' : 'border-gray-300 focus:ring-rose-500 focus:border-rose-500'
                }`}
                placeholder="John"
              />
              {errors.firstName && (
            ...
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                className={`block w-full shadow-sm rounded-md py-3 px-4 border ${
                  errors.lastName ? 'border-red-300 focus:ring-red-500 focus:border-red-500' : 'border-gray-300 focus:ring-rose-500 focus:border-rose-500'
                }`}
                placeholder="Doe"
              />
              {errors.lastName && (
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`pl-10 block w-full shadow-sm rounded-md py-3 px-4 border ${
                  errors.phone ? 'border-red-300 focus:ring-red-500 focus:border-red-500' : 'border-gray-300 focus:ring-rose-500 focus:border-rose-500'
                }`}
          ...
          <div>
            ...
            <select
              ...
              onChange={handleChange}
              className={`block w-full shadow-sm rounded-md py-3 px-4 border ${
                errors.country ? 'border-red-300 focus:ring-red-500 focus:border-red-500' : 'border-gray-300 focus:ring-rose-500 focus:border-rose-500'
              }`}
            >
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                onChange={handleChange}
                className={`pl-10 block w-full shadow-sm rounded-md py-3 px-4 border ${
                  errors.city ? 'border-red-300 focus:ring-red-500 focus:border-red-500' : 'border-gray-300 focus:ring-rose-500 focus:border-rose-500'
                }`}
